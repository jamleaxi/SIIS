                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="card card-dark">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-user-check mr-3"></i>Profile View</h3>
                        ...
                        @elseif($show_edit == true)
                            <div class="col-md-12 mt-3">
                                <div class="card card-blue">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-user-check mr-3"></i>Profile Update</h3>
                        ...
                        @else
                            <div class="col-md-12 mt-3">
                                <div class="card card-dark">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-user-check mr-3"></i>Active Users ({{ $count }})</h3>
...
@script
    <script>
        ...
        $('#nav-users-active').addClass('active');
