                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            <div class="card card-dark">
                                <div class="card-header">
                                    <h3 class="card-title"><i class="fas fa-user mr-3"></i>Profile View</h3>
                        ...
                        @elseif($show_edit == true)
                            <div class="col-md-12 mt-3">
                                <div class="card card-blue">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-user mr-3"></i>Profile Update</h3>
                        ...
                        @else
                            <div class="col-md-12 mt-3">
                                <div class="card card-dark">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-user mr-3"></i>Users ({{ $count }})</h3>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <tbody>
                                                @foreach($users as $user)
                                                    <tr>
                                                        ...
                                                        <td><img src="{{ $user->profile_photo_url }}" class="img-circle" width="25" height="25"></td>
                                                        <td>
                                                            @if($user->id == $my_id)
                                                                <b>{{ $user->name }} (You)</b>
                                                            @else
                                                        ...
                                                        <td>{{ $user->email }}</td>
                                                        <td>{{ $user->office }} ({{ $user->office_full }})</td>
                                                        <td>{{ $user->position }} ({{ $user->position_full }})</td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a class="btn btn-xs bg-primary" wire:click="viewUser({{ $user->id }})"><i class="fas fa-eye" style="cursor: pointer"></i></a>
                                                            <a class="btn btn-xs bg-purple" wire:click="editUser({{ $user->id }})"><i class="fas fa-building-user" style="cursor: pointer"></i></a>
                                                            
                                                            @if($user->status == "ACTIVE")
                                                                <a class="btn btn-xs bg-danger" wire:click="setDeactivate({{ $user->id }})"><i class="fas fa-user-xmark" style="cursor: pointer"></i></a>
                                                            @else
                                                                <a class="btn btn-xs bg-success" wire:click.prevent="setActivate({{ $user->id }})"><i class="fas fa-user-check" style="cursor: pointer"></i></a>
                                                            @endif

                                                            <a class="btn btn-xs bg-cyan" wire:click.prevent="setStaff({{ $user->id }})"><i class="fas fa-user-tie mr-1 ml-1" style="cursor: pointer"></i></a>
                                                            <a class="btn btn-xs bg-black" wire:click.prevent="setSuper({{ $user->id }})"><i class="fas fa-user-secret mr-1 ml-1" style="cursor: pointer"></i></a>

                                                            @if($user->status == "LOCKED")
                                                                <a class="btn btn-xs bg-maroon" wire:click.prevent="setDelete({{ $user->id }})"><i class="fas fa-trash-alt mr-1 ml-1" style="cursor: pointer"></i></a>
                                                            @endif
                                                        </td>
                                                    </tr>                                                    
                                                @endforeach
                                        ...
                                        <div class="col-12 mt-3 text-right"><a class="text-success">Active: {{ $user_active }}</a> | <a class="text-danger">Inactive: {{ $user_inactive }}</a> | <a class="text-warning">Locked: {{ $user_locked }}</a></div>
                                    </div>
                                </div>
                            </div>
                        @endif
...
@script
    <script>
        ...
        $('#nav-users-user').addClass('active');
