                                            ...
                                            <div class="card-body">
                                                ...
                                                <table align="center" width="100%" style="line-height: 1; table-layout: fixed;" >
                                                    <tr><!--  -->
                                                        ...
                                                        <td width="9%" class="myform-text-8-r mborder-bot-2 mborder-left mborder-right"><b><div id="lbTotal">₱{{ number_format($overall_total,2) }}</div></b></td>
                                            ...
                                            <div class="card card-blue card-tabs">
                                                <div class="card-header p-0 pt-1">
                                                    <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                                        ...
                                                        <li class="nav-item">
                                                            <a class="nav-link active" id="custom-tabs-two-sent-tab" data-toggle="pill" href="#custom-tabs-two-sent" role="tab" aria-controls="custom-tabs-two-sent" aria-selected="true"><i class="fas fa-paper-plane mr-2"></i>Sent</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                                ...
                                                <div class="card-body">
                                                    <div class="tab-content" id="custom-tabs-two-tabContent">
                                                        <div class="tab-pane fade show active" id="custom-tabs-two-sent" role="tabpanel" aria-labelledby="custom-tabs-two-sent-tab">
                                                            {{-- requests you initiated --}}
                                                            @if (count($requests) != 0)
                                                                <div class="timeline">
                                                                    @foreach ($unique_dates as $unique_date)
                                                                        <div class="time-label">
                                                                            <span class="bg-yellow">&nbsp;{{ \Carbon\Carbon::parse($unique_date->date_req)->format('F j, Y') }}&nbsp;</span>
                                                                        </div>

                                                                        @foreach ($requests->where('date_req','=',$unique_date->date_req) as $request)
                                                                            <div>
                                                                                @if ($request->status == 'FOR APPROVAL')
                                                                                    <i class="fas fa-user-check bg-yellow"></i>
                                                                                @elseif ($request->status == 'FOR ASSESSMENT')
                                                                                    <i class="fas fa-clipboard-check bg-maroon"></i>
                                                                                @elseif ($request->status == 'FOR ISSUANCE')
                                                                                ...
                                                                                <div class="timeline-item">
                                                                                    <span class="time"><i class="fas fa-ticket-alt mr-1"></i>{{ $request->tcode }} • Created: {{ \Carbon\Carbon::parse($request->created_at)->isoFormat('MMMM D, YYYY h:mm A') }} <i>({{ \Carbon\Carbon::parse($request->created_at)->diffForHumans(\Carbon\Carbon::now(),true) }} ago)</i></span>

                                                                                    @if ($request->status == 'FOR APPROVAL')
                                                                                        <h3 class="timeline-header">
                                                                                            <a class="text-yellow mr-1">
                                                                                                {{ $request->status }}: {{ $request->division }} - {{ $request->office }} <span class="text-gray"></span>
                                                                                    ...
                                                                                    @elseif ($request->status == 'COMPLETED')
                                                                                        <h3 class="timeline-header">
                                                                                            <a class="text-green mr-1">
                                                                                                ...
                                                                                                @if($request->date_rec)
                                                                                                    <span class="badge bg-green">You have confirmed this issuance</span>
                                                                                                @else
                                                                                                    <span class="badge bg-red">You have not confirmed this issuance</span>
                                                                                                @endif
                                                                                            </a>
                                                                                        </h3>
                                                                                    @endif
                                                                                    ...
                                                                                    <div class="timeline-body">
                                                                                        <div class="row mb-2">
                                                                                            <div class="col-12 mb-1">
                                                                                                <b class="text-gray">Purpose: </b>{{ $request->purpose }}
                                                                                            </div>

                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$request->requester_id) as $system_user_req)
                                                                                                    <img src="{{ $system_user_req->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Requester:</b>
                                                                                                    <b>{{ $request->requester }} - {{ $request->position_req }} <span class="text-blue">(You)</span></b>
                                                                                                @endforeach
                                                                                            </div>
                
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$request->approver_id) as $system_user_app)
                                                                                                    <img src="{{ $system_user_app->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Approver:</b>
                                                                                                    <b>{{ $request->approver }} - {{ $request->position_app }}</b>
                                                                                                @endforeach
                                                                                            </div>

                                                                                            @if ($request->assessor_id != '0')
                                                                                                <div class="col-6">
                                                                                                    @foreach($system_users->where('id','=',$request->assessor_id) as $system_user_ass)
                                                                                                        <img src="{{ $system_user_ass->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                        <b class="text-gray">Assessor: </b>
                                                                                                        <b>{{ $request->assessor }} - {{ $request->position_ass }}</b>
                                                                                                    @endforeach
                                                                                                </div>
                                                                                            @endif

                                                                                            @if ($request->issuer_id != null or $request->issuer_id != '')
                                                                                                <div class="col-6">
                                                                                                    @foreach($system_users->where('id','=',$request->issuer_id) as $system_user_iss)
                                                                                                        <img src="{{ $system_user_iss->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                        <b class="text-gray">Issuer: </b>
                                                                                                        <b>{{ $request->issuer }} - {{ $request->position_iss }}</b>
                                                                                                    @endforeach
                                                                                                </div>
                                                                                            @endif

                                                                                            @if ($request->receiver_id != null or $request->receiver_id != '')
                                                                                                <div class="col-6">
                                                                                                    @foreach($system_users->where('id','=',$request->receiver_id) as $system_user_rec)
                                                                                                        <img src="{{ $system_user_rec->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                        <b class="text-gray">Receiver: </b>
                                                                                                        <b>{{ $request->receiver }} - {{ $request->position_rec }}</b>
                                                                                                    @endforeach
                                                                                                </div>
                                                                                            @endif
                                                                                        </div>
                                                                                        ...
                                                                                        <div class="row border-top">
                                                                                            <div class="col-12 mt-2">
                                                                                                @if ($request->status == 'FOR APPROVAL')
                                                                                                    <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>
                                                                                                    @if ($request->submitted == 'no')
                                                                                                        @if ($request->approved == 'yes')
                                                                                                            <button class="btn bg-pink btn-sm" style="border-radius: 20px" wire:click.prevent='setSubmit({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-file-export mr-1"></i>Submit to Supply Office</button>
                                                                                                        @elseif($request->approved != 'no')
                                                                                                            <button class="btn bg-lightblue btn-sm" style="border-radius: 20px" wire:click='editRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-edit mr-1"></i>Modify Request</button>
                                                                                                            <button class="btn bg-pink btn-sm" style="border-radius: 20px" wire:click.prevent='setAppSubmit({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-arrows-turn-right mr-1"></i>Submit to Approver</button>
                                                                                                            <button class="btn bg-red btn-sm" style="border-radius: 20px" wire:click='setDelete({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-trash mr-1"></i>Delete Request</button>
                                                                                                        @endif
                                                                                                    @endif
                                                                                                @elseif ($request->status == 'FOR ASSESSMENT')
                                                                                                    <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>
                                                                                                    @if ($request->submitted == 'no')
                                                                                                        <button class="btn bg-lightblue btn-sm" style="border-radius: 20px" wire:click='editRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-edit mr-1"></i>Modify Request</button>
                                                                                                        <button class="btn bg-pink btn-sm" style="border-radius: 20px" wire:click.prevent='setSubmit({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-file-export mr-1"></i>Submit Request</button>
                                                                                                        <button class="btn bg-red btn-sm" style="border-radius: 20px" wire:click='setDelete({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-trash mr-1"></i>Delete Request</button>
                                                                                                    @endif
                                                                                                @elseif ($request->status == 'FOR ISSUANCE')
                                                                                                    <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>
                                                                                                    @if($request->ris_generation == 'yes')
                                                                                                        <button class="btn bg-lightblue btn-sm" style="border-radius: 20px" wire:click='viewGeneratedRIS({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-file-alt mr-1"></i>View Generated RIS</button>
                                                                                                    @endif
                                                                                                @elseif ($request->status == 'COMPLETED')
                                                                                                    <button class="btn bg-green btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>
                                                                                                    <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewGeneratedRIS({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-file-alt mr-1"></i>View Digital RIS</button>
                                                                                                    @if(!$request->date_rec)
                                                                                                        <button class="btn bg-red btn-sm" style="border-radius: 20px" wire:click.prevent='setConfirm({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-check-double mr-1"></i>Confirm Receipt of this Issuance</button>
                                                                                                    @else
                                                                                                        <button class="btn bg-maroon btn-sm" style="border-radius: 20px" wire:click='openRIS({{ $request->id }})' wire:loading.attr="disabled"><i class="fas fa-file-pdf mr-1"></i>View as PDF file</button>
                                                                                                    @endif
                                                                                                @endif
                                                                                            </div>
                                                                                        </div>
                                                            ...
                                                            @else
                                                                <i class="fas fa-info-circle mr-2"></i>You have no sent requests as of the moment.
                                                            @endif
                                                        </div>
                                                    </div>
                                                </div>
...
@script
    <script>
        ...
        $('#nav-request-sent').addClass('active');
        ...
        Livewire.on('triggerAppSubmit', t_id => {
            Swal.fire({
                title: 'Are you sure?',
                text: "This request will be submitted to your supervisor for approval.",
                icon: 'warning',
                ...
                if (result.isConfirmed) {
                    @this.set('appsubmit_confirm', true);
                }
            });
        });
        ...
        Livewire.on('triggerConfirm', t_id => {
            Swal.fire({
                title: 'Are you sure?',
                text: "This issuance will be confirmed and RIS form will be completed.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3d9970',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, confirm this issuance!'
            }).then((result) => {
                if (result.isConfirmed) {
                    @this.set('confirm_confirm', true);
                }
            });
        });
