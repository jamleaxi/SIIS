                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            @if($up_status == false)
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-12">
                                            <button type="" class="btn bg-blue" wire:click='showAddPanel'>
                                                ...
                                                Add new plant, property and equipment
                                            </button>
                                        </div>
                                    </div>
                                @else
                                    <div class="card card-blue">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-computer mr-3"></i>Plant, Property and Equipment</h3>
                                        ...
                                        <div class="card-body">
                                            <form wire:submit.prevent="validatePPE">
                                                @csrf
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="text" class="form-control" wire:model='code' id="code" placeholder="Input PPE number" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <select class="form-control" wire:model='category' id="category" required>
                                                                            ...
                                                                            @foreach($categories_ppe as $category_ppe)
                                                                                <option value="{{ $category_ppe->id }}">{{ $category_ppe->category }}</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                ...
                                <div class="card card-dark">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-computer mr-3 text-warning"></i>Plant, Property and Equipment ({{ $recordCount }})</h3>
                                        ...
                                        <table class="table table-bordered table-striped table-sm table-responsive-sm table-hover" style="font-size: 14px">
                                            <thead class="bg-blue" align="center">
                                                <tr>
                                                    <th><i class="mr-1 fas fa-qrcode"></i>
                                                        PPE#
                                                        <span wire:click="sortBy('properties.code')" class="float-right" style="cursor: pointer">
                                                            <i class="fas fa-arrow-up {{ $sortColumn === 'properties.code' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                                            <i class="fas fa-arrow-down {{ $sortColumn === 'properties.code' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                                        </span>
                                                    </th>
                                                    <th><i class="mr-1 fas fa-cube"></i>
                                                        Item
                                                        <span wire:click="sortBy('properties.item')" class="float-right" style="cursor: pointer">
                                                            <i class="fas fa-arrow-up {{ $sortColumn === 'properties.item' && $sortDirection === 'asc' ? '' : 'text-muted' }}"></i>
                                                            <i class="fas fa-arrow-down {{ $sortColumn === 'properties.item' && $sortDirection === 'desc' ? '' : 'text-muted' }}"></i>
                                                        </span>
                                                    </th>
                                            ...
                                            <tbody>
                                                @foreach ($properties as $property)
                                                    <tr>
                                                        <td align="center">{{ $property->ppe_code }}</td>
                                                        <td>{{ $property->ppe_item }}</td>
                                                        <td>{{ $property->ppe_description }}</td>
                                                        <td>{{ $property->ppe_category }}</td>
                                                        <td align="center">{{ $property->ppe_status }}</td>
                                                        <td align="center">{{ $property->ppe_date_acquired }}</td>
                                                        <td align="center">{{ $property->ppe_unit }}</td>
                                                        <td align="right">₱{{ number_format($property->ppe_price,2) }}</td>
                                                        <td align="center">{{ $property->ppe_fund }}</td>
                                                        <td>{{ $property->ppe_est_life }}</td>
                                                        <td>{{ $property->ppe_custodian }}</td>
                                                        <td align="center">
                                                            <button class="btn btn-xs bg-green" wire:click="updatePPE({{ $property->ppe_id }})"><i class="fas fa-pen mr-1" style="cursor: pointer"></i>Edit</button>
                                                            <button class="btn btn-xs bg-danger" wire:click="transferPPE({{ $property->ppe_id }})"><i class="fas fa-arrow-right mr-1" style="cursor: pointer"></i>Transfer</button>
                                                        </td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
                            ...
                            @else
                                @if($show_panel == 'update')
                                    <div class="card card-blue">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-computer mr-3"></i>Update Plant, Property and Equipment</h3>
                                        ...
                                        <div class="card-body">
                                            <form wire:submit.prevent="validatePPEUpdate">
                                                @csrf
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="code_up">&nbsp;&nbsp;&nbsp;PPE No.:</label>
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="text" class="form-control" wire:model='code_up' id="code_up" placeholder="Input PPE number" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                @elseif($show_panel == 'transfer')
                                    <div class="card card-blue">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-computer mr-3"></i>Transfer Plant, Property and Equipment</h3>
                                        ...
                                        <div class="card-body">
                                            <form wire:submit.prevent="validatePPETransfer">
                                                @csrf
...
@script
    <script>
        ...
        $('#nav-masterlist-ppe').addClass('active');
    </script>
@endscript