                    ...
                    <div class="row">
                        ...
                        @else --}}
                            <div class="col-6">
                                <div class="card card-dark">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-computer mr-3 text-warning"></i>Plant, Property and Equipment</h3>
                                    </div>
                                                    ...
                                                    @if($property->ppe_custodian == '' or $property->ppe_custodian == null)
                                                        <tr>
                                                            ...
                                                            <td align="center">
                                                                ...
                                                                @else
                                                                    <button class="btn btn-xs bg-yellow btnPick" id="{{ $property->ppe_id }}" wire:ignore wire:click="addToList({{ $property->ppe_id }})"><i class="fas fa-plus-circle mr-1"></i>Add to List</button>
                                                                @endif
                                                            </td>
                                                        </tr>
                                                    @else
                            ...
                            <div class="col-6">
                                <div class="card card-dark">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-list mr-3 text-warning"></i>Items for Receiving</h3>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <form wire:submit.prevent='validatePPERequest'>
                                                    @csrf
                                                    ...
                                                    @if($item_count > 0)
                                                        <div class="row">
                                                            <div class="col-6">
                                                                <div class="form-group">
                                                                    <label for="parnum">&nbsp;&nbsp;&nbsp;PAR Number:</label>
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="text" class="form-control" wire:model='parnum' id="parnum" placeholder="Input PAR number" required disabled>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-6">
                                                                <div class="row">
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            <label for="date_cus">&nbsp;&nbsp;&nbsp;Date Received by Recipient:</label>
...
@script
    <script>
        ...
        $('#nav-transaction-ppe').addClass('active');

        Livewire.on('transaction-added', () => {
            window.location.href = '/masterlist-ppe';
        });
    </script>
@endscript
