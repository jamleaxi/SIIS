                            ...
                            @if($up_status == false)
                                ...
                                @else
                                    <div class="card card-blue">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-landmark-flag mr-3"></i>Add Entity</h3>
                                        ...
                                        <div class="card-body">
                                            <form wire:submit.prevent="validateEntity">
                                                @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="entity_new">&nbsp;&nbsp;&nbsp;Entity Name:</label>
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="text" class="form-control" wire:model='entity_new' id="entity_new" placeholder="Input new entity name" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                @if($count > 0)
                                    <div class="card card-dark">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-landmark-flag mr-3"></i>Entities ({{ $count }})</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                @foreach($entities as $entity)
                                                    <button class="btn btn-sm btn-default col-3" wire:click="updateEntity({{ $entity->id }})">{{ $entity->entity }}</button>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-12">
                                        <div class="text-center mt-3 h5">
                                            <i class="fas fa-info-circle mr-1"></i>You have no encoded entities as of the moment.
                                        </div>
                                    </div>
                                @endif
                            @else
                                <div class="card card-blue">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-landmark-flag mr-3"></i>Update Entity</h3>
                                    ...
                                    <div class="card-body">
                                        <form wire:submit.prevent="validateEntityUpdate">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="entity_up">&nbsp;&nbsp;&nbsp;Entity Name:</label>
                                                                ...
                                                                <div class="input-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" wire:model='entity_up' id="entity_up" placeholder="Input updated entity name" required autofocus>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                <div class="col-12" align="center">
                                                    ...
                                                    <button type="submit" class="btn bg-danger" id="btnDelete" wire:click.prevent="$dispatch('triggerDelete',{{ $entity_id }})">
...
@script
    <script>
        ...
        $('#nav-custom-entity').addClass('active');

        Livewire.on('triggerDelete', entity_id => {
            Swal.fire({
                title: 'Are you sure?',
                ...
                confirmButtonText: 'Yes, delete this entity!'
            }).then((result) => {
