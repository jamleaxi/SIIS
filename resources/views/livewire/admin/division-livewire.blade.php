                            ...
                            @if($up_status == false)
                                ...
                                @else
                                    <div class="card card-blue">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-building-flag mr-3"></i>Add Division</h3>
                                        ...
                                        <div class="card-body">
                                            <form wire:submit.prevent="validateDivision">
                                                @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    <label for="division_new">&nbsp;&nbsp;&nbsp;Division Name:</label>
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="text" class="form-control" wire:model='division_new' id="division_new" placeholder="Input new division name" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                @if($count > 0)
                                    <div class="card card-dark">
                                        <div class="card-header">
                                            <h3 class="card-title"><i class="fas fa-building-flag mr-3"></i>Divisions ({{ $count }})</h3>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                @foreach($divisions as $division)
                                                    <button class="btn btn-sm btn-default col-3" wire:click="updateDivision({{ $division->id }})">{{ $division->division }}</button>
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
                                @else
                                    <div class="col-12">
                                        <div class="text-center mt-3 h5">
                                            <i class="fas fa-info-circle mr-1"></i>You have no encoded divisions as of the moment.
                                        </div>
                                    </div>
                                @endif
                            @else
                                <div class="card card-blue">
                                    <div class="card-header">
                                        <h3 class="card-title"><i class="fas fa-building-flag mr-3"></i>Update Division</h3>
                                    ...
                                    <div class="card-body">
                                        <form wire:submit.prevent="validateDivisionUpdate">
                                            @csrf
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <div class="form-group">
                                                                <label for="division_up">&nbsp;&nbsp;&nbsp;Division Name:</label>
                                                                ...
                                                                <div class="input-group col-md-12">
                                                                    ...
                                                                    <input type="text" class="form-control" wire:model='division_up' id="division_up" placeholder="Input updated division name" required autofocus>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="row mt-2 mb-2">
                                                <div class="col-12" align="center">
                                                    ...
                                                    <button type="submit" class="btn bg-danger" id="btnDelete" wire:click.prevent="$dispatch('triggerDelete',{{ $division_id }})">
...
@script
    <script>
        ...
        $('#nav-custom-division').addClass('active');

        Livewire.on('triggerDelete', division_id => {
            Swal.fire({
                title: 'Are you sure?',
                ...
                confirmButtonText: 'Yes, delete this division!'
            }).then((result) => {
