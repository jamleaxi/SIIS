                        ...
                        @else
                            ...
                            @else
                                <div class="col-12">
                                    ...
                                    @elseif($show_assess_pane == true)
                                        <div class="card card-dark">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-ticket mr-3"></i>REQUEST ASSESSMENT &nbsp;&nbsp;&nbsp;|<i class="ml-3 text-gray">{{ $tcode }}</i></h3>

                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" wire:click='hideAssessmentPane' wire:loading.attr="disabled">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-12">
                                                        <div class="info-box">
                                                            <div class="info-box-content">
                                                                <span class="info-box-text"><i class="mr-1 fas fa-building-flag"></i>Division: <b>{{ $division }}</b></span>
                                                                <span class="info-box-text"><i class="mr-1 fas fa-building"></i>Requesting office: <b>{{ $office }}</b></span>
                                                                <span class="info-box-text"><i class="mr-1 fas fas fa-info-circle"></i>Status: <b>{{ $status }}</b></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-12">
                                                        <div class="info-box">
                                                            <div class="info-box-content">
                                                                <span class="info-box-text"><i class="mr-1 fas fa-user-tag"></i>Requested by: <b>{{ $requester }} - {{ $position_req }}</b></span>
                                                                @if($sign_req == 'true')
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-calendar-day"></i>Date requested: <b>{{ \Carbon\Carbon::parse($date_req)->isoFormat('MMMM D, YYYY') }}</b></span>
                                                                    @foreach($esig_files->where('user_id','=',$requester_id) as $esig)
                                                                        <span class="info-box-text"><i class="mr-1 fas fa-signature"></i>Digitally signed:<img class="mr-1 ml-2" src="storage/{{ $esig->signature_path }}" width="20" height="20" alt="e-Signature"> <i class="text-sm text-gray">{{ $date_req }}</i></span>
                                                                    @endforeach
                                                                @else
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-calendar-day"></i>Date requested: <i class="text-gray">No info available.</i></span>
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-signature"></i>Digitally signed: <i class="text-gray">No info available.</i></span>
                                                                @endif
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-6 col-12">
                                                        <div class="info-box">
                                                            <div class="info-box-content">
                                                                <span class="info-box-text"><i class="mr-1 fas fa-user-check"></i>Approved by: <b>{{ $approver }} - {{ $position_app }}</b></span>
                                                                @if($sign_app == 'true')
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-calendar-day"></i>Date approved: <b>{{ \Carbon\Carbon::parse($date_app)->isoFormat('MMMM D, YYYY') }}</b></span>
                                                                    @foreach($esig_files->where('user_id','=',$approver_id) as $esig)
                                                                        <span class="info-box-text"><i class="mr-1 fas fa-signature"></i>Digitally signed:<img class="mr-1 ml-2" src="storage/{{ $esig->signature_path }}" width="20" height="20" alt="e-Signature"> <i class="text-sm text-gray">{{ $date_app }}</i></span>
                                                                    @endforeach
                                                                @else
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-calendar-day"></i>Date approved: <i class="text-gray">No info available.</i></span>
                                                                    <span class="info-box-text"><i class="mr-1 fas fa-signature"></i>Digitally signed: <i class="text-gray">No info available.</i></span>
                                                ...
                                                @if($accepted == 'yes')
                                                    <form wire:submit.prevent='validateAssessment'>
                                                        @csrf
                                                        ...
                                                        <div class="row">
                                                                    ...
                                                                    <div class="col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group col-md-12">
                                                                                ...
                                                                                <input type="text" class="form-control" wire:model='fund' id="fund" placeholder="Input fund source" required disabled>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-12">
                                                                <table class="table table-sm table-bordered table-responsive-sm table-hover">
                                                                    <thead class="bg-blue" align="center">
                                                                        <tr>
                                                                            <th width="25%"><i class="mr-1 fas fa-cube"></i>Description</th>
                                                                            <th width="9%"><i class="mr-1 fas fa-hashtag"></i>Qty Requested</th>
                                                                            <th width="10%"><i class="mr-1 fas fa-box"></i>Unit</th>
                                                                            @if($type == 'standard')
                                                                                <th width="7%"><i class="mr-1 fas fa-clipboard"></i>Available</th>
                                                                                <th width="10%"><i class="mr-1 fas fa-bar-chart"></i>In Stock</th>
                                                                            @endif
                                                                            <th width="9%"><i class="mr-1 fas fa-hashtag"></i>Qty Issued</th>
                                                                            <th width="10%"><i class="mr-1 fas fa-cash-register"></i>Price</th>
                                                                            <th width="10%"><i class="mr-1 fas fa-file-alt"></i>Reference</th>
                                                                            {{-- <th width="10%"><i class="mr-1 fas fa-calculator"></i>Total</th> --}}
                                                                            <th width="10%"><i class="mr-1 fas fa-paperclip"></i>Remarks</th>
                                                                        </tr>
                                                                    </thead>
                                                                        ...
                                                                        @foreach($requested_items as $requested_item)
                                                                            <tr>
                                                                                ...
                                                                                @if($type == 'standard')
                                                                                    ...
                                                                                    <td align="center">{{ $requested_item['stock'] }}</td>
                                                                                    <td align="center">
                                                                                        @if($requested_item['stock'] <= 0)
                                                                                            <input type="number" min="0" max="0" class="form-control form-control-sm text-center" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                        @else
                                                                                            @if($requested_item['qty'] >= $requested_item['stock'])
                                                                                                <input type="number" min="0" max="{{ $requested_item['stock'] }}" class="form-control form-control-sm text-center" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                            @else
                                                                                                <input type="number" min="0" max="{{ $requested_item['qty'] }}" class="form-control form-control-sm text-center" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                            @endif
                                                                                        @endif
                                                                                    </td>
                                                                                @else
                                                                                    <td align="center"><input type="number" min="0" max="{{ $requested_item['qty'] }}" class="form-control form-control-sm text-center" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required></td>
                                                                                @endif
                                                                                <td align="right">₱{{ number_format($requested_item['price'],2) }}</td>
                                                                                <td>{{ $requested_item['ref'] }}</td>
                                                                                <td><input type="type" tabindex="-1" class="form-control form-control-sm" wire:model="requested_items.{{ $loop->index }}.remarks" placeholder="Remarks"></td>
                                                                            </tr>
                                                                        @endforeach
                                                                    </tbody>
                                                                    <tfoot class="bg-blue" align="center">
                                                            ...
                                                            <div class="col-12 text-sm text-danger"><b><i>**Prices may vary on the RIS depending on the available reference stock.</i></b></div>
                                                            {{-- <div class="col-12">TOTAL >> Items: {{ $item_count }} || Quantity Requested: {{ $quantity_count }} || Overall cost: ₱{{ number_format($overall_total,2) }}</div> --}}

                                                            <div class="col-12 mt-3 text-right">
                                                                <button type="submit" class="btn bg-blue"><i class="fas fa-caret-right mr-2"></i>Save Assessment</button>
                                                            </div>
                                                        </div>
                                                    </form>
                                                @else
                                                    <div class="row">
                                                        <div class="col-12">
                                                            <table class="table table-sm table-bordered table-responsive-sm table-hover">
                                                                <thead class="bg-blue" align="center">
                                                                    <tr>
                                                                        <th width="25%"><i class="mr-1 fas fa-cube"></i>Description</th>
                                                                        <th><i class="mr-1 fas fa-hashtag"></i>Qty Requested</th>
                                                                        <th><i class="mr-1 fas fa-box"></i>Unit</th>
                                                                        <th><i class="mr-1 fas fa-clipboard"></i>Available</th>
                                                                        <th><i class="mr-1 fas fa-bar-chart"></i>In Stock</th>
                                                                        <th><i class="mr-1 fas fa-cash-register"></i>Active Price</th>
                                                                        <th><i class="mr-1 fas fa-file-alt"></i>Active Source</th>
                                                                    </tr>
                                                                </thead>
                                                        ...
                                                        <div class="col-12">TOTAL >> Items: {{ $item_count }} || Quantity Requested: {{ $quantity_count }}</div>

                                                        <div class="col-12 mt-3 text-right">
                                                            @if($accepted == 'no')
                                                                <button class="btn bg-warning" wire:click='revokeRequest' wire:loading.attr="disabled"><i class="fas fa-times-circle mr-2"></i>Revoke Rejection</button>
                                                            @elseif($accepted == null)
                                                                <button class="btn bg-red" wire:click='declineRequest' wire:loading.attr="disabled"><i class="fas fa-times-circle mr-2"></i>Reject Request</button>
                                                                <button class="btn bg-green" wire:click='acceptRequest' wire:loading.attr="disabled"><i class="fas fa-check-circle mr-2"></i>Accept Request</button>
                                                            @endif
                                                        </div>
                                                    </div>
                                                @endif
                                    ...
                                    @elseif($show_issue_pane == true)
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-thumbs-up mr-3"></i>ISSUE REQUEST [{{ $tcode }}] - RIS No. {{ $risnum }}</h3>

                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" wire:click='hideIssuePane' wire:loading.attr="disabled">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-12 text-center text-bold text-light bg-danger mb-3">
                                                        NOTE: Upon confirmation, this request will be marked as complete.
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6" align="center">
                                                        <form wire:submit.prevent='validateIssue'>
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="date" class="form-control" wire:model='date_issued' id="date_issued" placeholder="Input date issued" required autofocus>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <select class="form-control" wire:model='issued_to' id="issued_to" required>
                                                                            <option value="" class="text-blue">••• Please select a receiver:</option>
                                                                            @foreach($users as $user)
                                                                                <option value="{{ $user->id }}">{{ $user->name }} - {{ $user->office }} ({{ $user->position_full }})</option>
                                                                            @endforeach
                                                                        </select>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group col-md-12">
                                                                        ...
                                                                        <input type="date" class="form-control" wire:model='date_received' id="date_received" placeholder="Input date received" required>
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <div class="col-12 text-center mt-3">
                                                                <button type="submit" class="btn bg-blue"><i class="fas fa-signature mr-2"></i>Confirm Issuance</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                                                    ...
                                                                                    <tbody>
                                                                                        @foreach($requested_items as $requested_item)
                                                                                            <tr>
                                                                                                ...
                                                                                                <td align="right"><input type="number" class="form-control form-control-sm" wire:model="requested_items.{{ $loop->index }}.qty" placeholder="Qty" required></td>
                                    ...
                                    @elseif($show_assess_edit_pane == true)
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-ticket mr-3"></i>EDIT REQUEST ASSESSMENT [{{ $tcode }}]</h3>

                                                <div class="card-tools">
                                                    <button type="button" class="btn btn-tool" wire:click='hideEditAssessmentPane' wire:loading.attr="disabled">
                                                        <i class="fas fa-times"></i>
                                                    </button>
                                                </div>
                                            </div>
                                            ...
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-4">
                                                        | Requesting office: <b>{{ $division }} - {{ $office }}</b>
                                                        <br>
                                                        | Date created: <b>{{ \Carbon\Carbon::parse($date_req)->isoFormat('MMMM D, YYYY') }}</b>
                                                    </div>

                                                    <div class="col-4">
                                                        | Requested by: <b>{{ $requester }} - {{ $position_req }}</b>
                                                        <br>
                                                        @if($sign_req == 'true')
                                                            | Date requested: <b>{{ \Carbon\Carbon::parse($date_req)->isoFormat('MMMM D, YYYY') }}</b>
                                                        @else
                                                            {{-- | Requestor has not yet signed. --}}
                                                            | Requestor has no date requested data yet.
                                                        @endif
                                                    </div>

                                                    <div class="col-4">
                                                        | Approved by: <b>{{ $approver }} - {{ $position_app }}</b>
                                                        <br>
                                                        @if($sign_app == 'true')
                                                            | Date approved: <b>{{ \Carbon\Carbon::parse($date_app)->isoFormat('MMMM D, YYYY') }}</b>
                                                        @else
                                                            {{-- | Approver has not yet signed. --}}
                                                            | Approver has no date approved data yet.
                                                        @endif
                                                    </div>
                                                    ...
                                                    @if($assessor_id)
                                                        <div class="col-4 mb-3">
                                                            | Assessed by: <b>{{ $assessor }} - {{ $position_ass }}</b>
                                                            <br>
                                                            @if($sign_ass == 'true')
                                                                | Date assessed: <b>{{ \Carbon\Carbon::parse($date_ass)->isoFormat('MMMM D, YYYY') }}</b>
                                                            @else
                                                                | Assessor has no date assessed data yet.
                                                            @endif
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if($issuer_id)
                                                        <div class="col-4 mb-3">
                                                            | Issued by: <b>{{ $issuer }} - {{ $position_iss }}</b>
                                                            <br>
                                                            @if($sign_iss == 'true')
                                                                | Date issued: <b>{{ \Carbon\Carbon::parse($date_iss)->isoFormat('MMMM D, YYYY') }}</b>
                                                            @else
                                                                | Issuer has no date issued data yet.
                                                            @endif
                                                        </div>
                                                    @endif
                                                    ...
                                                    @if($receiver_id)
                                                        <div class="col-4 mb-3">
                                                            | Received by: <b>{{ $receiver }} - {{ $position_rec }}</b>
                                                            <br>
                                                            @if($sign_rec == 'true')
                                                                | Date received: <b>{{ \Carbon\Carbon::parse($date_rec)->isoFormat('MMMM D, YYYY') }}</b>
                                                            @else
                                                                | Receiver has no date received data yet.
                                                            @endif
                                                        </div>
                                                    @endif
                                                ...
                                                <form wire:submit.prevent='validateEditAssessment'>
                                                    @csrf
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <table class="table table-sm table-bordered table-responsive-sm table-hover">
                                                                <thead class="bg-blue" align="center">
                                                                    <tr>
                                                                        ...
                                                                        @if($type == 'standard')
                                                                            <th width="7%"><i class="mr-1 fas fa-clipboard"></i>Available</th>
                                                                            <th width="10%"><i class="mr-1 fas fa-bar-chart"></i>Remaining Stock</th>
                                                                        @endif
                                                                        <th width="9%"><i class="mr-1 fas fa-hashtag"></i>Qty Issued</th>
                                                                        <th width="10%"><i class="mr-1 fas fa-cash-register"></i>Price</th>
                                                                        <th width="10%"><i class="mr-1 fas fa-calculator"></i>Total</th>
                                                                    ...
                                                                    @foreach($requested_items as $requested_item)
                                                                        <tr>
                                                                            ...
                                                                            @if($type == 'standard')
                                                                                ...
                                                                                <td align="center">
                                                                                    @if($requested_item['stock'] <= 0)
                                                                                        <input type="number" min="0" max="0" class="form-control form-control-sm text-center" wire:keyup="getTotal({{ $loop->index }})" wire:change="getTotal({{ $loop->index }})" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                    @else
                                                                                        @if($requested_item['qty'] >= $requested_item['stock'])
                                                                                            <input type="number" min="0" max="{{ $requested_item['stock'] }}" class="form-control form-control-sm text-center" wire:keyup="getTotal({{ $loop->index }})" wire:change="getTotal({{ $loop->index }})" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                        @else
                                                                                            <input type="number" min="0" max="{{ $requested_item['qty'] }}" class="form-control form-control-sm text-center" wire:keyup="getTotal({{ $loop->index }})" wire:change="getTotal({{ $loop->index }})" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required>
                                                                                        @endif
                                                                                    @endif
                                                                                </td>
                                                                            @else
                                                                                <td align="center"><input type="number" min="0" max="{{ $requested_item['qty'] }}" class="form-control form-control-sm text-center" wire:keyup="getTotal({{ $loop->index }})" wire:change="getTotal({{ $loop->index }})" wire:model="requested_items.{{ $loop->index }}.qtyi" placeholder="Qty Issued" required></td>
                                                                            @endif
                                                                            <td align="right">₱{{ number_format($requested_item['price'],2) }}</td>
                                                                            <td align="right">₱{{ number_format($requested_item['total'],2) }}</td>
                                                                            <td><input type="type" tabindex="-1" class="form-control form-control-sm" wire:model="requested_items.{{ $loop->index }}.remarks" placeholder="Remarks"></td>
                                                                        </tr>                                                    
                                                                    @endforeach
                                                                </tbody>
                                                        ...
                                                        <div class="col-12 mt-3 text-right">
                                                            <button type="submit" class="btn bg-blue"><i class="fas fa-arrow-circle-up mr-2"></i>Save Update</button>
                                                        </div>
                                                    </div>
                                                </form>
                                            </div>
                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="card-header p-0 pt-1">
                                                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="custom-tabs-two-assess-tab" data-toggle="pill" href="#custom-tabs-two-assess" role="tab" aria-controls="custom-tabs-two-assess" aria-selected="true"><i class="fas fa-check-to-slot mr-2"></i>For Assessment</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-two-assess" role="tabpanel" aria-labelledby="custom-tabs-two-assess-tab">
                                                        {{-- requests for assessment --}}
                                                        @if (count($assesss) != 0)
                                                            <div class="timeline">
                                                                @foreach ($unique_dates_as as $unique_date_as)
                                                                    <div class="time-label">
                                                                        <span class="bg-yellow">&nbsp;{{ \Carbon\Carbon::parse($unique_date_as->date_app)->format('F j, Y') }}&nbsp;</span>
                                                                    </div>

                                                                    @foreach ($assesss->where('date_app','=',$unique_date_as->date_app) as $assess)
                                                                        <div>
                                                                            <i class="fas fa-clipboard-check bg-maroon"></i>

                                                                            <div class="timeline-item">
                                                                                <span class="time"><i class="fas fa-ticket-alt mr-1"></i>{{ $assess->tcode }} • Created: {{ \Carbon\Carbon::parse($assess->created_at)->isoFormat('MMMM D, YYYY h:mm A') }} <i>({{ \Carbon\Carbon::parse($assess->created_at)->diffForHumans(\Carbon\Carbon::now(),true) }} ago)</i></span>

                                                                                @if ($assess->status == 'FOR ASSESSMENT')
                                                                                <h3 class="timeline-header">
                                                                                    <a class="text-maroon mr-1">
                                                                                        {{ $assess->status }}: {{ $assess->division }} - {{ $assess->office }} <span class="text-gray"></span>

                                                                                        @if($assess->type == 'standard')
                                                                                ...
                                                                                <div class="timeline-body">
                                                                                    <div class="row mb-2">
                                                                                        <div class="col-12 mb-1">
                                                                                            <b class="text-gray">Purpose: </b>{{ $assess->purpose }}
                                                                                        </div>

                                                                                        <div class="col-6">
                                                                                            @foreach($system_users->where('id','=',$assess->requester_id) as $system_user_req)
                                                                                                <img src="{{ $system_user_req->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                <b class="text-gray">Requester:</b>
                                                                                                <b>{{ $assess->requester }} - {{ $assess->position_req }}</b>
                                                                                            @endforeach
                                                                                        </div>
            
                                                                                        <div class="col-6">
                                                                                            @foreach($system_users->where('id','=',$assess->approver_id) as $system_user_app)
                                                                                                <img src="{{ $system_user_app->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                <b class="text-gray">Approver:</b>
                                                                                                <b>{{ $assess->approver }} - {{ $assess->position_app }}</b>
                                                                                            @endforeach
                                                                                        </div>

                                                                                        @if ($assess->assessor_id != '0')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assess->assessor_id) as $system_user_ass)
                                                                                                    <img src="{{ $system_user_ass->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Assessor: </b>
                                                                                                    <b>{{ $assess->assessor }} - {{ $assess->position_ass }}</b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif

                                                                                        @if ($assess->issuer_id != null or $assess->issuer_id != '')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assess->issuer_id) as $system_user_iss)
                                                                                                    <img src="{{ $system_user_iss->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Issuer: </b>
                                                                                                    <b>{{ $assess->issuer }} - {{ $assess->position_iss }}</b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif

                                                                                        @if ($assess->receiver_id != null or $assess->receiver_id != '')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assess->receiver_id) as $system_user_rec)
                                                                                                    <img src="{{ $system_user_rec->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Receiver: </b>
                                                                                                    <b>{{ $assess->receiver }} - {{ $assess->position_rec }}</b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="row border-top">
                                                                                        <div class="col-12 mt-2">
                                                                                            @if ($assess->status == 'FOR ASSESSMENT')
                                                                                                <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $assess->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>

                                                                                                @if($assess->accepted == 'yes')
                                                                                                    <button class="btn bg-lightblue btn-sm" style="border-radius: 20px" wire:click='confirmAssessRequest({{ $assess->id }})' wire:loading.attr="disabled"><i class="fas fa-check-to-slot mr-1"></i>Assess this Request</button>
                                                                                                @elseif($assess->accepted == 'no')
                                                                                                    <button class="btn bg-red btn-sm" style="border-radius: 20px" wire:click='confirmAssessRequest({{ $assess->id }})' wire:loading.attr="disabled"><i class="fas fa-arrow-rotate-left mr-1"></i>Revoke Rejection</button>
                                                                                                @else
                                                                                                    <button class="btn bg-purple btn-sm" style="border-radius: 20px" wire:click='confirmAssessRequest({{ $assess->id }})' wire:loading.attr="disabled"><i class="fas fa-check-double mr-1"></i>Accept/Reject Request</button>
                                                                                                @endif
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <div>
                                                                    <i class="fas fa-check-to-slot bg-gray"></i>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <i class="fas fa-info-circle mr-2"></i>There are no requests for assessment as of the moment.
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
...
@script
    <script>
        ...
        $('#nav-request-assessment').addClass('active');
        ...
        Livewire.on('triggerGenerate', t_id => {
            Swal.fire({
                title: 'Are you sure?',
                text: "Once the RIS is generated, you will no longer be able to make any changes to it.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3d9970',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, generate RIS for this request.'
            }).then((result) => {
                if (result.isConfirmed) {
                    @this.set('generate_confirm', true);
                }
            });
        });
    </script>
