                            ...
                            @else
                                <div class="col-12">
                                    ...
                                    @elseif($show_assess_pane == true)
                                        <div class="card">
                                            <div class="card-header">
                                                <h3 class="card-title"><i class="fas fa-ticket mr-3"></i>REQUEST ASSESSMENT [{{ $tcode }}]</h3>
                                        ...
                                        <div class="col-12 col-sm-12">
                                            ...
                                            <div class="card-header p-0 pt-1">
                                                <ul class="nav nav-tabs" id="custom-tabs-two-tab" role="tablist">
                                                    ...
                                                    <li class="nav-item">
                                                        <a class="nav-link active" id="custom-tabs-two-assessed-tab" data-toggle="pill" href="#custom-tabs-two-assessed" role="tab" aria-controls="custom-tabs-two-assessed" aria-selected="true"><i class="fas fa-clipboard-check mr-2"></i>For Issuance</a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div class="card-body">
                                                <div class="tab-content" id="custom-tabs-two-tabContent">
                                                    <div class="tab-pane fade show active" id="custom-tabs-two-assessed" role="tabpanel" aria-labelledby="custom-tabs-two-assessed-tab">
                                                        {{-- assessed requests --}}
                                                        @if (count($assessments) != 0)
                                                            <div class="timeline">
                                                                @foreach ($unique_dates_ass as $unique_date_ass)
                                                                    <div class="time-label">
                                                                        <span class="bg-yellow">&nbsp;{{ \Carbon\Carbon::parse($unique_date_ass->date_ass)->format('F j, Y') }}&nbsp;</span>
                                                                    </div>

                                                                    @foreach ($assessments->where('date_ass','=',$unique_date_ass->date_ass) as $assessment)
                                                                        <div>
                                                                            <i class="fas fa-thumbs-up bg-blue"></i>

                                                                            <div class="timeline-item">
                                                                                <span class="time"><i class="fas fa-ticket-alt mr-1"></i>{{ $assessment->tcode }} • Created: {{ \Carbon\Carbon::parse($assessment->created_at)->isoFormat('MMMM D, YYYY h:mm A') }} <i>({{ \Carbon\Carbon::parse($assessment->created_at)->diffForHumans(\Carbon\Carbon::now(),true) }} ago)</i></span>

                                                                                @if ($assessment->status == 'FOR ISSUANCE')
                                                                                    <h3 class="timeline-header">
                                                                                        <a class="text-blue mr-1">
                                                                                            {{ $assessment->status }}: {{ $assessment->division }} - {{ $assessment->office }} <span class="text-gray"></span>
                                                                                ...
                                                                                <div class="timeline-body">
                                                                                    <div class="row mb-2">
                                                                                        <div class="col-12 mb-1">
                                                                                            <b class="text-gray">Purpose: </b>{{ $assessment->purpose }}
                                                                                        </div>

                                                                                        <div class="col-6">
                                                                                            @foreach($system_users->where('id','=',$assessment->requester_id) as $system_user_req)
                                                                                                <img src="{{ $system_user_req->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                <b class="text-gray">Requester:</b>
                                                                                                <b>{{ $assessment->requester }} - {{ $assessment->position_req }}</b>
                                                                                            @endforeach
                                                                                        </div>
            
                                                                                        <div class="col-6">
                                                                                            @foreach($system_users->where('id','=',$assessment->approver_id) as $system_user_app)
                                                                                                <img src="{{ $system_user_app->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                <b class="text-gray">Approver:</b>
                                                                                                <b>{{ $assessment->approver }} - {{ $assessment->position_app }}</b>
                                                                                            @endforeach
                                                                                        </div>

                                                                                        @if ($assessment->assessor_id != '0')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assessment->assessor_id) as $system_user_ass)
                                                                                                    <img src="{{ $system_user_ass->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Assessor: </b>
                                                                                                    <b>{{ $assessment->assessor }} - {{ $assessment->position_ass }} <span class="text-blue">(You)</span></b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif

                                                                                        @if ($assessment->issuer_id != null or $assessment->issuer_id != '')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assessment->issuer_id) as $system_user_iss)
                                                                                                    <img src="{{ $system_user_iss->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Issuer: </b>
                                                                                                    <b>{{ $assessment->issuer }} - {{ $assessment->position_iss }}</b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif

                                                                                        @if ($assessment->receiver_id != null or $assessment->receiver_id != '')
                                                                                            <div class="col-6">
                                                                                                @foreach($system_users->where('id','=',$assessment->receiver_id) as $system_user_rec)
                                                                                                    <img src="{{ $system_user_rec->profile_photo_url }}" class="img-circle mr-1" width="20" height="20">
                                                                                                    <b class="text-gray">Receiver: </b>
                                                                                                    <b>{{ $assessment->receiver }} - {{ $assessment->position_rec }}</b>
                                                                                                @endforeach
                                                                                            </div>
                                                                                        @endif
                                                                                    </div>
                                                                                    ...
                                                                                    <div class="row border-top">
                                                                                        <div class="col-12 mt-2">
                                                                                            @if ($assessment->status == 'FOR ISSUANCE')
                                                                                                <button class="btn bg-blue btn-sm" style="border-radius: 20px" wire:click='viewRequestDetails({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-eye mr-1"></i>View Request Details</button>
                                                                                                @if($assessment->ris_generation == 'yes')
                                                                                                    <button class="btn bg-lightblue btn-sm" style="border-radius: 20px" wire:click='viewGeneratedRIS({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-file-alt mr-1"></i>View Generated RIS</button>
                                                                                                    @if($my_level == 'YES')
                                                                                                        <button class="btn bg-pink btn-sm" style="border-radius: 20px" wire:click='setIssueRequest({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-signature mr-1"></i>Issue this Request</button>
                                                                                                    @endif
                                                                                                @else
                                                                                                    {{-- <button class="btn bg-purple btn-sm" style="border-radius: 20px" wire:click='confirmEditAssessment({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-arrows-turn-to-dots mr-1"></i>Re-assess Request</button> --}}
                                                                                                    <button class="btn bg-gray btn-sm" style="border-radius: 20px" wire:click='viewGeneratedRIS({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-file-circle-question mr-1"></i>Preview RIS Form</button>
                                                                                                    <button class="btn bg-pink btn-sm" style="border-radius: 20px" wire:click='setGenerate({{ $assessment->id }})' wire:loading.attr="disabled"><i class="fas fa-arrows-spin mr-1"></i>Generate RIS Form</button>
                                                                                                @endif
                                                                                            @endif
                                                                                        </div>
                                                                                    </div>
                                                                ...
                                                                <div>
                                                                    <i class="fas fa-clipboard-check bg-gray"></i>
                                                                </div>
                                                            </div>
                                                        @else
                                                            <i class="fas fa-info-circle mr-2"></i>There are no requests for issuance as of the moment.
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
...
@script
    <script>
        ...
        $('#nav-request-issuance').addClass('active');
        ...
        Livewire.on('triggerGenerate', t_id => {
            Swal.fire({
                title: 'Are you sure?',
                text: "Once the RIS is generated, you will no longer be able to make any changes to it and this form will be visible to the requester.",
                icon: 'warning',
        ...
        Livewire.on('triggerIssue', t_id => {
            Swal.fire({
                title: 'Are you sure?',
                text: "This request will be signed and issued to the requester.",
                icon: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3d9970',
                cancelButtonColor: '#d33',
                confirmButtonText: 'Yes, issue this request.'
            }).then((result) => {
                if (result.isConfirmed) {
                    @this.set('issue_confirm', true);
                }
            });
        });
        
        Livewire.on('triggerRemind', t_id => {
            Swal.fire({
                title: 'NOTICE',
                text: "Please remind the requester to confirm receipt of this issuance on their system portal.",
                icon: 'info',
            });
        });
    </script>
