...
class AllLivewire extends Component
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function render()
    {
        ...
        {
            $allusers = User::orderBy('name','asc')->paginate($this->pagination);
            $this->alluser_active = count(User::where('status','=','ACTIVE')->orderBy('name','asc')->get());
            $this->alluser_inactive = count(User::where('status','=','INACTIVE')->orderBy('name','asc')->get());
            $this->alluser_locked = count(User::where('status','=','LOCKED')->orderBy('name','asc')->get());
        ...
        {
            $allusers = User::where('name','like','%'.$this->searchQuery.'%')->orWhere('email','like','%'.$this->searchQuery.'%')->orderBy('name','asc')->paginate($this->pagination);
            $this->alluser_active = count(User::where('status','=','ACTIVE')->where('name','like','%'.$this->searchQuery.'%')->orderBy('name','asc')->get());
            $this->alluser_inactive = count(User::where('status','=','INACTIVE')->where('name','like','%'.$this->searchQuery.'%')->orderBy('name','asc')->get());
            $this->alluser_locked = count(User::where('status','=','LOCKED')->where('name','like','%'.$this->searchQuery.'%')->orderBy('name','asc')->get());

            $this->resultCount = User::where('name','like','%'.$this->searchQuery.'%')->orWhere('email','like','%'.$this->searchQuery.'%')->orderBy('name','asc')->count(); 
        ...
        return view('livewire.super.all-livewire',[
            'allusers' => $allusers,
            'positions' => $positions,
            'offices' => $offices,
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    protected $listeners = [
        ...
        'alluser-issued' => '$refresh',
        'alluser-issued-remove' => '$refresh',
        'alluser-staff-remove' => '$refresh',
    ];
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
