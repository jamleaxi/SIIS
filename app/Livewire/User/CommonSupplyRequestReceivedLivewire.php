...
class CommonSupplyRequestReceivedLivewire extends Component
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function render()
    {
        ...
        return view('livewire.user.common-supply-request-received-livewire', [
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function approveRequest()
    {
        ...
        $app->date_app = Carbon::today()->format('Y-m-d');
        $app->sign_app = 'true';
        $app->assessor_id = '0';
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function saveAssessment()
    {
        ...
        $ass->date_ass = Carbon::today()->format('Y-m-d');
        $ass->sign_ass = 'true';
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    {
        if($this->issued_to == '0' or $this->issued_to == '' or $this->issued_to == null)
        {
            session()->flash('warning','Please select a receiver!');
        }
        else
        {
            $this->issueRequest();
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    {
        if($this->division == '' or $this->division == null or $this->division == '0' or $this->division == 0)
        {
            session()->flash('warning','Please select a division!');
        }
        else
        {
            if($this->approver_id == '' or $this->approver_id == null or $this->approver_id == '0' or $this->approver_id == 0)
            {
                session()->flash('warning','Please select an approver!');
            }
            else
            {
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function updateCSTransaction()
    {
        ...
        $transaction->date_req = Carbon::today()->format('Y-m-d');
        ...
        $transaction->date_app = Carbon::today()->format('Y-m-d');
