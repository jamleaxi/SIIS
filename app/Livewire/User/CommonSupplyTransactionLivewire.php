...
class CommonSupplyTransactionLivewire extends Component
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    // for transaction code generationF
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function render()
    {
        ...
        $this->requester = Auth::user()->name;
        $this->requester_id = Auth::user()->id;
        $this->position_req = Auth::user()->position;

        $users = User::where('role','!=', 'Superadmin')->where('id','!=', Auth::user()->id)->where('status','=', 'ACTIVE')->orderBy('name','asc')->get();
        ...
        $unconfirmed = CommonSupplyTransaction::where('requester_id','=',$this->my_id)
            ->where('sign_rec','!=','true')
            ->get()->count();
        ...
        return view('livewire.user.common-supply-transaction-livewire',[
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function addToList($id)
    {
        ...
        $this->added_items[] = ['id' => $add_this->id, 'code' => $add_this->code, 'item' => $add_this->item, 'description' => $add_this->description, 'unit' => $this_unit->unit, 'qty' => '', 'fund' => $add_this->fund];
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function removeFromList($index)
    {
        ...
        if (isset($this->added_items[$index])) {
            ...
            $this->dispatch('cs-removed', [$this->itd]);
        }
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function addCSTransaction()
    {
        ...
        session()->flash('success','Request successfully sent for approval!');
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
