...
class CommonSupplyRequestSentLivewire extends Component
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    public $appsubmit_confirm = false;
    public $delete_confirm = false;
    public $generate_confirm = false;
    public $confirm_confirm = false;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function render()
    {
        ...
        if($this->appsubmit_confirm == true)
        {
            $this->submitAppRequestDetails();
        }
        ...
        return view('livewire.user.common-supply-request-sent-livewire', [
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function approveRequest()
    {
        ...
        session()->flash('success','Request successfully approved and sent for assessment.');
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function openRIS($id)
    {
        $st = CommonSupplyTransaction::find($id);
        $this->tcode = $st->tcode;
        $this->dispatch('triggerOpen', $this->tcode);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function confirmIssueRequest($id)
    {
        // get transaction details
        $rd = CommonSupplyTransaction::find($id);
        $this->t_id = $rd->id;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    {
        $it = User::find($this->issued_to);
        $iss = CommonSupplyTransaction::find($this->t_id);
        $iss->date_iss = $this->date_issued;
        $iss->sign_iss = 'true';
        $iss->receiver_id = $it->id;
        $iss->receiver = $it->name;
        $iss->position_rec = $it->position;
        $iss->date_rec = $this->date_received;
        $iss->sign_rec = 'true';
        ...
        foreach($this->requested_items as $requested_item)
        {
            if($this->type == 'standard')
            {
                ...
                foreach($ii as $in)
                {
                    ...
                    $io->date_released = $this->date_received;
                    $io->save();
                }
            }
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function submitRequestDetails()
    {
        $sr = CommonSupplyTransaction::find($this->t_id);
        $sr->assessor_id = '0';
        $sr->status = 'FOR ASSESSMENT';
        $sr->submitted = 'yes';
        $sr->save();

        $this->resetSubmit();

        session()->flash('success','Request successfully submitted to supply office.');
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function submitAppRequestDetails()
    {
        $sr = CommonSupplyTransaction::find($this->t_id);
        $sr->approved = 'no';
        $sr->date_req = Carbon::now()->format('Y-m-d H:i:s');
        $sr->save();
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function setAppSubmit($id)
    {
        $this->t_id = $id;

        $this->dispatch('triggerAppSubmit', $this->t_id);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function resetAppSubmit()
    {
        $this->appsubmit_confirm = false;
        $this->reset(['t_id']);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function confirmRequest()
    {
        $cn = CommonSupplyTransaction::find($this->t_id);
        $cn->receiver_id = $this->my_id;
        $cn->receiver = $this->my_name;
        $cn->position_rec = $this->my_position;
        $cn->date_rec = Carbon::now()->format('Y-m-d H:i:s');
        $cn->sign_rec = 'true';
        $cn->save();
        ...
        session()->flash('success','Issuance successfully confirmed.');

        $this->dispatch('r-updated', $cn);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function updateConfirm()
    {
        // get transaction items
        $received_items = CommonSupplyTransactionItem::where('transaction_id','=',$this->t_id)->get();
        ...
        foreach($received_items as $received_item)
        {
            if($this->type == 'standard')
            {
                ...
                {
                    $io = CommonSupplyOut::find($in->id);
                    $io->date_released = Carbon::now()->format('Y-m-d H:i:s');
                    $io->save();
                }
            }

            $ui = CommonSupplyTransactionItem::find($received_item['id']);
            $ui->disbursed = 'yes';
            $ui->save();
        }
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function setConfirm($id)
    {
        ...
        $this->dispatch('triggerConfirm', $this->t_id);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function resetConfirm()
    {
        $this->confirm_confirm = false;
        $this->reset(['t_id','type']);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
