...
class CommonSupplyRequestSharedLivewire extends Component
{
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    ...
    public $approve_confirm = false;
    public $return_confirm = false;
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function render()
    {
        ...
        if($this->approve_confirm == true)
        {
            $this->approveRequest();
        }

        if($this->return_confirm == true)
        {
            $this->returnRequest();
        }
        ...
        return view('livewire.user.common-supply-request-shared-livewire', [
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function setApproveRequest($id)
    {
        $this->t_id = $id;
        $this->dispatch('triggerApprove', $this->t_id);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function approveRequest()
    {
        ...
        $app->sign_app = 'true';
        $app->approved = 'yes';
        // send directly to supply office
        $app->assessor_id = '0';
...
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function setReturnRequest($id)
    {
        $this->t_id = $id;
        $this->dispatch('triggerReturn', $this->t_id);
    }
// - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
    public function returnRequest()
    {
        ...
        session()->flash('success','Request successfully returned.');
